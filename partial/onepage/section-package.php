                ...
                <div class="container">
                    <div class="row">
                        <div class="col-12 col-sm-9 col-md-9 col-lg-9">
                            <div class="cta-large">
                                <h2><?php echo esc_html__(get_theme_mod('cta_heading'), 'amitasker') ?></h2>
                                <p><?php echo esc_html__(get_theme_mod('cta_sub_heading'), 'amitasker') ?></p>
                            </div>
                        </div>
                        <div class="col-12 col-sm-3 col-md-3 col-lg-3">
                            <div class="cta-btn">
                                <?php if(get_theme_mod('cta_btn_link')) :  ?>
                                    <a href="<?php echo esc_html__(get_theme_mod('cta_btn_link'), 'amitasker') ?>" class="btn btn-ami btn-primary"><?php echo esc_html__(get_theme_mod('cta_btn_text'), 'amitasker') ?></a>
                                <?php endif;  ?>
                            </div>
                        </div>
                    </div>
