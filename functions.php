...
function amitasker_scripts(){
    ...
    */
    ...
    wp_register_script( 'jquery-migrate', get_template_directory_uri()."/assets/vendor/jquery/jquery-migrate-3.0.0.min.js", array('jquery', 'jquery-migrate'), '3.1.1', true);
...
add_filter( 'script_loader_tag', 'script_data', 10, 3 );
