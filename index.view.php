                    ...
                    <div class="row text-center">
                        <div class="col-md-3 col-sm-3 col-12">
                            <div class="single-stats">
                                <span class="h2 counting">250</span>
                        ...
                        <div class="col-md-3 col-sm-3 col-12">
                            <div class="single-stats">
                                <span class="h2 counting">150</span>
                        ...
                        <div class="col-md-3 col-sm-3 col-12">
                            <div class="single-stats">
                                <span class="h2 counting">420</span>
                        ...
                        <div class="col-md-3 col-sm-3 col-12">
                            <div class="single-stats">
                                <span class="h2 counting">95%</span>
                    ...
                    <div class="row">
                        ...
                        <div class="col-12 col-sm-4 col-md-4 col-lg-4">
                            <div class="single-service-details">
                                ...
                                <h4>Social Media Advertising Services</h4>
                                <p>Lorem ipsum dolor sit, amet consectetur adipisicing elit. Similique commodi
                                    provident nisi voluptatum iure? Ducimus.</p>
                            </div>
                        </div>
                        <div class="col-12 col-sm-4 col-md-4 col-lg-4">
                            <div class="single-service-details">
                                ...
                                <h4>Social Media Content Creations</h4>
                                <p>Lorem ipsum dolor sit, amet consectetur adipisicing elit. Similique commodi
                                    provident nisi voluptatum iure? Ducimus.</p>
                            </div>
                        </div>
                        <div class="col-12 col-sm-4 col-md-4 col-lg-4">
                            <div class="single-service-details">
                                ...
                                <h4>Social Media Influencer Management</h4>
                                <p>Lorem ipsum dolor sit, amet consectetur adipisicing elit. Similique commodi
                                    provident nisi voluptatum iure? Ducimus.</p>
                            </div>
                        </div>
                        <div class="col-12 col-sm-4 col-md-4 col-lg-4">
                            <div class="single-service-details">
                                ...
                                <h4>Monitor Social Media Ads and Optimize</h4>
                                <p>Lorem ipsum dolor sit, amet consectetur adipisicing elit. Similique commodi
                                    provident nisi voluptatum iure? Ducimus.</p>
                            </div>
                        </div>
                        <div class="col-12 col-sm-4 col-md-4 col-lg-4">
                            <div class="single-service-details">
                                ...
                                <h4>Social Media Reporting and Communication</h4>
                                <p>Lorem ipsum dolor sit, amet consectetur adipisicing elit. Similique commodi
                                    provident nisi voluptatum iure? Ducimus.</p>
                            </div>
                        </div>
